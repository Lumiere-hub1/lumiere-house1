...
export default function PerformanceScreen() {
  ...
  return <ScreenShell title="Performance imports" eyebrow={workspace.name} subtitle="Bring in real outcomes without inventing lift.">
    <View style={{ gap: 16 }}>
      <Surface tone="ink" style={{ borderColor: brand.border }}><Text style={{ color: brand.text, fontSize: 17, fontWeight: "700" }}>Evidence, not estimates.</Text><Text style={{ color: brand.muted, fontSize: 13, lineHeight: 19 }}>Imports create an auditable batch and only valid rows become analytics events. Rejected rows remain visible.</Text></Surface>
