...
export default function AnalyticsScreen() {
  ...
  return <ScreenShell title="Results" eyebrow={workspace.name} subtitle="Actual events first. Learning comes after evidence.">
    <View style={{ gap: 16 }}>
      <Surface tone="ink" style={{ borderColor: brand.ink }}><Text style={{ color: brand.cream, fontSize: 17, fontWeight: "700" }}>No invented lift.</Text><Text style={{ color: "#D8C9BA", fontSize: 13, lineHeight: 19 }}>Lumière only shows performance that arrived from a connected system or was explicitly recorded by your team.</Text></Surface>
      <SectionLabel>Results lens</SectionLabel>
      <Surface><View style={{ gap: 12 }}><View style={{ flexDirection: "row", justifyContent: "space-between" }}><Text style={{ color: brand.muted, fontSize: 13 }}>Target</Text><Text style={{ color: brand.ink, fontSize: 14, fontWeight: "700" }}>{resultsLens.targetLabel}</Text></View><View style={{ flexDirection: "row", justifyContent: "space-between" }}><Text style={{ color: brand.muted, fontSize: 13 }}>Forecast</Text><Text style={{ color: brand.ink, fontSize: 14, fontWeight: "700" }}>{resultsLens.forecastLabel}</Text></View><View style={{ flexDirection: "row", justifyContent: "space-between" }}><Text style={{ color: brand.muted, fontSize: 13 }}>Actual results</Text><Text style={{ color: brand.ink, fontSize: 14, fontWeight: "700" }}>{resultsLens.actualLabel}</Text></View>{resultsLens.progress !== null ? <View style={{ gap: 6 }}><View style={{ height: 8, backgroundColor: brand.sand, borderRadius: 999, overflow: "hidden" }}><View style={{ width: `${resultsLens.progress}%`, height: "100%", backgroundColor: brand.green, borderRadius: 999 }} /></View><Text style={{ color: brand.muted, fontSize: 12 }}>{resultsLens.progress}% of target recorded</Text></View> : null}<Text style={{ color: brand.muted, fontSize: 12, lineHeight: 18 }}>{resultsLens.assumptions}</Text></View></Surface>
      <View style={{ flexDirection: "row", gap: 12 }}><View style={{ flex: 1 }}><Surface><Text style={{ color: brand.muted, fontSize: 12 }}>Events recorded</Text><Text style={{ color: brand.ink, fontSize: 28, fontWeight: "700", paddingTop: 5 }}>{events.data?.length || 0}</Text></Surface></View><View style={{ flex: 1 }}><Surface><Text style={{ color: brand.muted, fontSize: 12 }}>Insights</Text><Text style={{ color: brand.ink, fontSize: 28, fontWeight: "700", paddingTop: 5 }}>{learning.data?.length || 0}</Text></Surface></View></View>
