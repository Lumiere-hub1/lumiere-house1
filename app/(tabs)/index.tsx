...
export default function TodayScreen() {
  ...
  return <ScreenShell title="Today" eyebrow={workspace.name} subtitle="The few actions that deserve your attention now." action={<IconButton icon="settings" label="Open settings" onPress={() => router.push("/settings" as any)} />}>
    <View style={{ gap: 16 }}>
      <Surface tone="ink" style={{ borderColor: brand.border }}><Text style={{ color: brand.text, fontSize: 17, fontWeight: "700", lineHeight: 23 }}>Good work is focused work.</Text><Text style={{ color: brand.muted, fontSize: 13, lineHeight: 19 }}>Lumière uses what is actually in your workspace to decide what deserves a next step.</Text></Surface>
