...
export default function AutomateScreen() {
  ...
  return <ScreenShell title="Automate" eyebrow={workspace.name} subtitle="Let Lumière prepare work, never take uncontrolled action.">
    <View style={{ gap: 16 }}>
      <Surface tone="ink" style={{ borderColor: brand.border }}><Text style={{ color: brand.text, fontSize: 17, fontWeight: "700" }}>Human control is part of the engine.</Text><Text style={{ color: brand.muted, fontSize: 13, lineHeight: 19 }}>Every recipe carries approval requirements, quiet hours, action limits, and a visible pause state.</Text></Surface>
