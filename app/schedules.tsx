...
export default function SchedulesScreen() {
  ...
  return <ScreenShell title="Schedules" eyebrow={workspace.name} subtitle="Prepare recurring work without surrendering control.">
    <View style={{ gap: 16 }}>
      <Surface tone="ink" style={{ borderColor: brand.ink }}><Text style={{ color: brand.cream, fontSize: 17, fontWeight: "700" }}>Bounded by design.</Text><Text style={{ color: "#D8C9BA", fontSize: 13, lineHeight: 19 }}>Schedules begin paused. Approval, quiet hours, action limits, and an authorized connector are checked before execution.</Text></Surface>
